...
<head>
    ...
    <title>Client | Créer un compte</title>
    ...
    ?>
        <div class="login-form">
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
                ...
                ?>
                    <p class="text-center text-success"><?php echo sessionGet('Success'); ?></p>
                <?php
                }
                ?>
                <div class="form-group has-error">
                    <input type="text" class="form-control <?php if (sessionHas('Error_Nom')) echo 'is-invalid'; ?>" name="Nom" placeholder="Nom" value="<?php if (sessionHas('Old_Nom')) echo sessionGet('Old_Nom'); ?>">
                </div>
                <?php if (sessionHas('Error_Nom')) { ?>
                    <p class="float-left text-danger">
                        <?php echo sessionGet('Error_Nom'); ?>
                    </p>
                <?php } ?>
                <div class="form-group has-error">
                ...
                <p><a href="client.php">Connexion</a></p>
            </form>
            <?php
            sessionRemove('Old_Nom');
            sessionRemove('Old_Pseudo');
            sessionRemove('Error');
            sessionRemove('Error_Nom');
